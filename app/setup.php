...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_script('sage/app.js', asset('js/app.js')->uri(), ['sage/vendor.js', 'jquery'], null, true);
...
add_action('enqueue_block_editor_assets', function () {
    if ($manifest = asset('js/manifest.asset.php')->get()) {
        wp_enqueue_script('sage/vendor.js', asset('js/vendor.js')->uri(), $manifest['dependencies'], null, true);
